<template>
  <section class="py-12 flex px-4 lg:px-36 w-full flex-col justify-center items-center gap-8 bg-slate-100 relative">
    <h3 class="text-2xl lg:text-4xl font-bold">Testimonials</h3>
